...
INSERT INTO "TutorApplications" (
    "Id", "UserId", "Bio", "Education", "University", "Major", "DegreeLevel",
    "Certifications", "Subject", "SubjectSub", "ExperienceYears", "TeachingMode",
    "Address", "Latitude", "Longitude", "Methodology", "Achievements",
    "DocumentsJson", "Status", "SubmittedAt", "RejectionReason",
    "ReviewedByAdminId", "ReviewedAt"
)
VALUES
    ('22222222-aaaa-aaaa-aaaa-000000000001', '22222222-1111-1111-1111-111111111111', 'Chuyên luyện thi THPT QG môn Toán 5 năm kinh nghiệm.', 'Cử nhân Sư phạm Toán - ĐH Sư phạm Hà Nội', 'ĐH Sư phạm Hà Nội', 'Sư phạm Toán', 'Cử nhân', 'Chứng chỉ Nghiệp vụ Sư phạm Giỏi', 'Toán học', 'THPT, Luyện thi ĐH', 5, 'Both', '123 Cầu Giấy, Hà Nội', 21.0333, 105.7833, 'Hệ thống hóa kiến thức theo sơ đồ tư duy, kết hợp giải đề thực chiến từ ngân hàng 500+ đề thi các trường chuyên.', 'Giúp 25+ học sinh đạt điểm 8.5+ môn Toán trong kỳ thi tốt nghiệp THPT.', '[{"id":"doc-1","title":"Bằng Cử nhân Sư phạm Toán","institution":"ĐH Sư phạm Hà Nội","format":"PDF • 2.1 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-2","title":"Chứng chỉ Nghiệp vụ Sư phạm Giỏi","institution":"ĐH Sư phạm Hà Nội","format":"PDF • 1.4 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Approved', NOW() - INTERVAL '50 days', NULL, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '49 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000002', '33333333-1111-1111-1111-111111111111', 'Giảng viên IELTS 8.0, chiến thuật phòng thi thực chiến.', 'Thạc sĩ Ngôn ngữ Anh - ĐH Ngoại Thương', 'ĐH Ngoại Thương', 'Ngôn ngữ Anh', 'Thạc sĩ', 'IELTS 8.0 Overall', 'Tiếng Anh', 'Giao tiếp, IELTS 6.5+', 4, 'Online', NULL, NULL, NULL, 'Ứng dụng phương pháp phản xạ chủ động và sửa lỗi trực tiếp trong từng buổi học.', 'Hơn 40 học viên đạt mục tiêu IELTS 6.5 - 7.5 sau khóa học 3 tháng.', '[{"id":"doc-3","title":"Bằng Thạc sĩ Ngôn ngữ Anh","institution":"ĐH Ngoại Thương","format":"PDF • 2.4 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-4","title":"Chứng chỉ IELTS 8.0","institution":"British Council","format":"PDF • 1.9 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Approved', NOW() - INTERVAL '45 days', NULL, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '44 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000003', '44444444-1111-1111-1111-111111111111', 'Kỹ sư phần mềm & Gia sư Vật lý THPT.', 'Kỹ sư CNTT - ĐH Bách Khoa Hà Nội', 'ĐH Bách Khoa Hà Nội', 'Kỹ thuật Phần mềm', 'Kỹ sư', 'Chứng nhận Olympic Tin học Sinh viên', 'Vật lý & Lập trình', 'THPT & C#, Python', 3, 'Both', 'Quận 10, TP.HCM', 10.7719, 106.6678, 'Kết hợp mô phỏng 3D bài toán vật lý và bài tập thực hành lập trình thực tế.', 'Bồi dưỡng học sinh đạt giải Ba học sinh giỏi cấp Thành phố môn Vật lý.', '[{"id":"doc-5","title":"Bằng Tốt nghiệp Kỹ sư CNTT","institution":"ĐH Bách Khoa Hà Nội","format":"PDF • 2.8 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"}]', 'Approved', NOW() - INTERVAL '40 days', NULL, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '39 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000004', '44444444-3333-1111-1111-111111111111', 'Giáo viên Tiếng Nhật JLPT N1, du học sinh Nhật Bản 4 năm.', 'Cử nhân Nhật Bản Học - ĐH KHXH&NV', 'ĐH KHXH&NV', 'Nhật Bản Học', 'Cử nhân', 'JLPT N1', 'Tiếng Nhật', 'N5 - N2, Giao tiếp', 4, 'Online', NULL, NULL, NULL, 'Phương pháp Shadowing và rèn luyện kỹ năng nghe nói với người bản xứ.', '30+ học viên đỗ chứng chỉ JLPT N3 và N2 đúng kỳ vọng.', '[{"id":"doc-6","title":"Bằng Cử nhân Nhật Bản Học","institution":"ĐH KHXH&NV","format":"PDF • 1.8 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-7","title":"Chứng chỉ Tiếng Nhật JLPT N1","institution":"Japan Foundation","format":"PDF • 1.2 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Approved', NOW() - INTERVAL '30 days', NULL, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '29 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000005', '44444444-4444-1111-1111-111111111111', 'Thạc sĩ Văn học, luyện thi tốt nghiệp THPT và vào lớp 10 chuyên.', 'Thạc sĩ Văn học - ĐH Sư phạm TP.HCM', 'ĐH Sư phạm TP.HCM', 'Sư phạm Ngữ văn', 'Thạc sĩ', 'Chứng chỉ Phương pháp Giảng dạy Hiện đại', 'Ngữ văn', 'THPT & Luyện thi ĐH', 6, 'Both', 'Bình Thạnh, TP.HCM', 10.8030, 106.7050, 'Phát triển năng lực cảm thụ văn học, rèn luyện kỹ năng lập dàn ý và diễn đạt mạch lạc, giàu cảm xúc.', 'Nhiều học sinh đạt điểm 9+ môn Văn trong kỳ thi tốt nghiệp THPT Quốc gia.', '[{"id":"doc-8","title":"Bằng Thạc sĩ Sư phạm Văn học","institution":"ĐH Sư phạm TP.HCM","format":"PDF • 2.6 MB","verified":true,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"}]', 'Approved', NOW() - INTERVAL '25 days', NULL, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '24 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000006', '44444444-2222-1111-1111-111111111111', 'Sinh viên năm 2 muốn làm gia sư Hóa học.', 'Sinh viên ĐH Kinh tế Quốc Dân', 'ĐH Kinh tế Quốc Dân', 'Quản trị Kinh doanh', 'Sinh viên', 'Chưa có chứng chỉ sư phạm', 'Hóa học', 'THCS, Lớp 8-9', 0, 'Offline', 'Hai Bà Trưng, Hà Nội', 21.0000, 105.8500, 'Học thuộc công thức và giải bài tập sách giáo khoa cơ bản.', 'Chưa có thành tích tiêu biểu.', '[{"id":"doc-9","title":"Thẻ sinh viên ĐH KTQD","institution":"ĐH Kinh tế Quốc Dân","format":"PNG • 950 KB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"}]', 'Rejected', NOW() - INTERVAL '35 days', 'Thiếu bằng cấp hoặc chứng chỉ chuyên môn liên quan đến Hóa học.', '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL '34 days'),
    ('22222222-aaaa-aaaa-aaaa-000000000007', '55555555-4444-1111-1111-111111111111', 'Ứng tuyển gia sư Lập trình Python & Web cơ bản.', 'Sinh viên năm 3 ĐH FPT', 'ĐH FPT', 'Kỹ thuật Phần mềm', 'Sinh viên năm 3', 'Chứng chỉ Python Programming, AWS Cloud Practitioner', 'Lập trình', 'Python & Web Cơ bản', 1, 'Online', NULL, NULL, NULL, 'Học qua dự án thực tế (Project-based learning), xây dựng ứng dụng web ngay sau khóa học.', 'Hướng dẫn 10+ học sinh THPT xây dựng trang portfolio cá nhân đầu tay.', '[{"id":"doc-10","title":"Bảng điểm sinh viên ĐH FPT","institution":"ĐH FPT Hà Nội","format":"PDF • 1.5 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-11","title":"Chứng chỉ Python Professional","institution":"Coursera / FPT","format":"PDF • 1.1 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Pending', NOW() - INTERVAL '3 days', NULL, NULL, NULL),
    ('22222222-aaaa-aaaa-aaaa-000000000008', '55555555-5555-1111-1111-111111111111', 'Gia sư Tiếng Pháp DELF B2.', 'Cử nhân Ngôn ngữ Pháp - ĐH Hà Nội', 'ĐH Hà Nội', 'Ngôn ngữ Pháp', 'Cử nhân', 'Chứng chỉ Tiếng Pháp DELF B2, Nghiệp vụ Sư phạm', 'Ngoại ngữ', 'Tiếng Pháp Giao tiếp & DELF', 2, 'Both', 'Thanh Xuân, Hà Nội', 20.9980, 105.8050, 'Rèn luyện ngữ âm chuẩn bản ngữ, phản xạ tự nhiên thông qua các tình huống hội thoại thực tế.', 'Kèm cặp 8 học viên thi đỗ chứng chỉ DELF B1 và B2 trong vòng 6 tháng.', '[{"id":"doc-12","title":"Bằng Cử nhân Ngôn ngữ Pháp","institution":"ĐH Hà Nội","format":"PDF • 2.2 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-13","title":"Chứng chỉ Tiếng Pháp DELF B2","institution":"Viện Pháp tại Hà Nội","format":"PDF • 1.3 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Pending', NOW() - INTERVAL '2 days', NULL, NULL, NULL),
    ('22222222-aaaa-aaaa-aaaa-000000000009', '55555555-6666-1111-1111-111111111111', 'Gia sư Sinh học bồi dưỡng học sinh giỏi.', 'Bác sĩ Đa khoa - ĐH Y Hà Nội', 'ĐH Y Hà Nội', 'Bác sĩ Đa khoa', 'Bác sĩ', 'Giải Nhì Olympic Sinh học Quốc gia', 'Sinh học', 'THPT & Bồi dưỡng HSG', 3, 'Both', 'Đống Đa, Hà Nội', 21.0180, 105.8270, 'Hệ thống hóa cơ chế sinh học phân tử và di truyền bằng hình ảnh trực quan và sơ đồ tư duy liên kết.', '12 học sinh đạt điểm 9+ môn Sinh học trong kỳ thi tốt nghiệp THPT Quốc gia.', '[{"id":"doc-14","title":"Bằng Bác sĩ Đa khoa","institution":"ĐH Y Hà Nội","format":"PDF • 2.9 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-15","title":"Bảng điểm tốt nghiệp","institution":"ĐH Y Hà Nội","format":"PDF • 1.7 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Pending', NOW() - INTERVAL '1 day', NULL, NULL, NULL),
    ('22222222-aaaa-aaaa-aaaa-000000000010', '44444444-2222-1111-1111-111111111111', 'Nộp lại đơn ứng tuyển gia sư Hóa sau khi bổ sung chứng chỉ sư phạm.', 'Sinh viên ĐH Kinh tế Quốc Dân + Chứng chỉ NVSP', 'ĐH Kinh tế Quốc Dân', 'Quản trị Kinh doanh & Sư phạm', 'Cử nhân', 'Chứng chỉ Nghiệp vụ Sư phạm Hóa học ĐH Sư phạm Hà Nội', 'Hóa học', 'THCS & Lớp 10', 1, 'Both', 'Hai Bà Trưng, Hà Nội', 21.0000, 105.8500, 'Cá nhân hóa theo năng lực từng học sinh, tập trung phản ứng cốt lõi và chuỗi biến hóa hóa học dễ nhớ.', 'Kèm cặp hơn 15 học sinh tiến bộ từ 5 lên 8 điểm môn Hóa học.', '[{"id":"doc-16","title":"Bằng Cử nhân Kinh tế","institution":"ĐH Kinh tế Quốc Dân","format":"PDF • 2.0 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80"},{"id":"doc-17","title":"Chứng chỉ Nghiệp vụ Sư phạm Hóa học","institution":"ĐH Sư phạm Hà Nội","format":"PDF • 1.5 MB","verified":false,"previewUrl":"https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80"}]', 'Pending', NOW() - INTERVAL '5 hours', NULL, NULL, NULL);
