...
{
    // Vietnamese mobile phone numbers format: starts with 03, 05, 07, 08, 09 followed by 8 digits
    ...
    public UpdateMyProfileCommandValidator()
    {
        ...
        RuleFor(x => x.Phone)
            ...
            .WithMessage("Phone number must be a valid Vietnamese mobile number (e.g. 0912345678 or +84912345678).");
