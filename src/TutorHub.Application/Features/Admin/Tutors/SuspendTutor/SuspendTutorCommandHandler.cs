...
public class SuspendTutorCommandHandler : IRequestHandler<SuspendTutorCommand, AdminTutorDto>
{
    private readonly IAppDbContext _context;

    public SuspendTutorCommandHandler(IAppDbContext context)
    {
        _context = context;
    }

    public async Task<AdminTutorDto> Handle(SuspendTutorCommand request, CancellationToken cancellationToken)
    {
        ...
        tutor.Status = TutorProfileStatus.Suspended;
