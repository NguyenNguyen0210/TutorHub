...
export default function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden py-7 sm:py-8 lg:py-10 bg-gradient-to-r from-[#EFF6FF] to-[#ECFEFF] border-b border-sky-100/70">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5">
            <h1 className="text-[32px] sm:text-[42px] lg:text-[48px] font-bold text-neutral-900 leading-[1.12] tracking-tight">
              ...
              <span className="text-[#2563EB]">cho mục tiêu của bạn</span>
            </h1>
            ...
            <form
              ...
              className="relative w-full max-w-[580px] h-[52px] flex items-center bg-white p-1.5 rounded-full border border-neutral-200/90 shadow-brand-sm hover:shadow-brand-md focus-within:ring-2 focus-within:ring-[#2563EB]/20 focus-within:border-[#2563EB] transition-all"
              role="search"
            ...
            >
              ...
              <button
                type="submit"
                className="h-[40px] px-4 sm:px-5 rounded-full bg-[#2563EB] hover:bg-[#1D4ED8] active:bg-[#1E40AF] text-white text-[13.5px] sm:text-[14px] font-semibold flex items-center justify-center gap-1.5 shrink-0 transition-colors cursor-pointer shadow-sm"
          ...
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[480px] flex items-center justify-center pt-2 pb-1 select-none">
              ...
              <div
                className="absolute top-4 sm:top-5 right-1 sm:right-2 bg-white/95 backdrop-blur-md p-2.5 sm:p-3 rounded-[16px] sm:rounded-[18px] shadow-[0_10px_25px_rgba(0,0,0,0.08)] border border-white/80 max-w-[140px] sm:max-w-[155px] text-left z-20 animate-float"
              ...
              <a
                href="#tutors-grid"
                className="absolute bottom-4 sm:bottom-6 left-1 sm:left-2 bg-white/95 backdrop-blur-md p-2 sm:p-2.5 sm:px-3 rounded-xl sm:rounded-2xl shadow-[0_12px_32px_rgba(0,0,0,0.09)] border border-white/80 flex items-center gap-2 sm:gap-2.5 z-20 group hover:shadow-lg transition-all animate-float cursor-pointer"
              ...
              >
                ...
                <div className="leading-tight text-left pr-0.5">
                  <p className="text-[12px] sm:text-[12.5px] font-bold text-[#0F172A] group-hover:text-[#2563EB] transition-colors">
                    {totalCount > 0 ? `${totalCount}+ gia sư chất lượng` : '55+ gia sư chất lượng'}
                  </p>
                  <p className="text-[10px] sm:text-[10.5px] text-[#64748B] mt-0.5">Đã được xác thực</p>
                </div>
